...
function mayuscula(nombre) {
  ...
  //Tu código:
  let mayus = nombre[0].toUpperCase() + nombre.substring(1);
  return mayus;
}
...
/*   for(let i = 0; i < numeros.length; i++){
  ...
  cb(suma); */
  var newarrray = numeros.reduce((el , acc) => el + acc, suma)
  cb(newarrray);
}
...
function filter(array) {
  ...
  //Tu código:
  var azu = array.filter(function(elemento){return elemento.charAt(0) === "a";})
  return azu;
}
